...
class SwinIR(nn.Module):
    ...
    def __init__(
        ...
        if self.upsampler == "pixelshuffle":
            ...
            self.upsample = UpsampleOneStep(sf, embed_dim, num_out_ch, (patches_resolution[0], patches_resolution[1]))
...
def create_swinir_model(ckpt_path):
    ...
    if "params_ema" in ckpt:
        ...
        state_dict = {layer_name.replace("model.", ""): weights for layer_name, weights in state_dict.items()}
        state_dict = {layer_name.replace("module.", ""): weights for layer_name, weights in state_dict.items()}
